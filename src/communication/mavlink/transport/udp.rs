...
// Re-export platform-specific implementation when pico2_w is enabled
#[cfg(feature = "pico2_w")]
...
pub struct UdpTransport {
    ...
    gcs_endpoints: Vec<MockGcsEndpoint, MAX_GCS_ENDPOINTS>,
