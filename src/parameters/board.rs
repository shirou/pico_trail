...
impl BoardParams {
    ...
    pub fn register_defaults(_store: &mut ParameterStore) -> Result<()> {
        ...
        #[cfg(feature = "pico2_w")]
        {
            ...
            let store = _store; // Rename for scoped use
...
mod tests {
    ...
    fn test_register_defaults() {
        ...
        // Verify motor pin parameters registered (only on pico2_w feature)
        #[cfg(feature = "pico2_w")]
        {
            use crate::platform::traits::board::BOARD_CONFIG;
