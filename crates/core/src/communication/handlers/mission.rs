...
use crate::mission::{MissionStorage, Waypoint, MISSION_SEQUENCER, MISSION_STORAGE};
...
impl MissionHandler {
    ...
    pub fn handle_clear_all(
        ...
        let is_armed_and_running = {
            ...
            let running =
                MISSION_SEQUENCER.with(|seq| seq.state() == crate::mission::MissionState::Running);
            armed && running
        };
        ...
        crate::communication::status_notifier::send_notice("Mission cleared");
        self.create_ack(
    ...
    pub fn handle_set_current(
        ...
        let result = MISSION_SEQUENCER.with_mut(|sequencer| {
            MISSION_STORAGE.with(|storage| {
                ...
                struct NoOpExecutor;
                impl crate::mission::MissionExecutor for NoOpExecutor {
                    fn start_command(
                        &mut self,
                        _cmd: &Waypoint,
                    ) -> crate::mission::CommandStartResult {
                        crate::mission::CommandStartResult::Accepted
                    }
...
mod tests {
    ...
    fn test_upload_flow() {
        ...
        assert_eq!(request.target_system, 255);
    ...
    fn test_download_flow() {
        ...
        assert_eq!(count_msg.target_system, 255);
