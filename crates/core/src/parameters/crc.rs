...
///
/// ```
/// use pico_trail_core::parameters::crc::calculate_crc32;
///
...
///
/// ```
/// use pico_trail_core::parameters::crc::{calculate_crc32, validate_crc32};
///
...
mod tests {
    ...
    fn test_crc32_detects_corruption() {
        ...
        // Flip a single bit
        let mut corrupted = [0u8; 13];
        corrupted.copy_from_slice(data);
        corrupted[0] ^= 0x01;
