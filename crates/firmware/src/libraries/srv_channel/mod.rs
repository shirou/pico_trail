//! Actuator abstraction for rover steering and throttle (firmware wrapper)
//!
//! This module re-exports core actuator types and provides platform-specific
//! implementations using Embassy PWM.
//!
//! ## Safety
//!
...
// Re-export core actuator types and functions
pub use pico_trail_core::servo::{
    duty_cycle_to_pulse, normalized_to_pulse, pulse_to_duty_cycle, ActuatorConfig,
    ActuatorInterface,
};
...
impl<'a> ActuatorInterface for Actuators<'a> {
    fn set_steering(&mut self, normalized: f32) -> Result<(), &'static str> {
        ...
        // Convert to pulse width using core function
        let pulse_us = normalized_to_pulse(
            value,
        ...
        // Convert to duty cycle using core function
        let duty = pulse_to_duty_cycle(pulse_us);
...
mod tests {
    ...
    fn test_normalized_to_pulse() {
        ...
        // Tests use the core free function (re-exported above)
