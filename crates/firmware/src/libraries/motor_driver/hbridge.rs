//! H-bridge motor driver implementation (firmware version with logging)
//!
...
//!
//! This firmware-specific implementation adds debug logging for motor operations.
//! For the pure no_std version without logging, see `pico_trail_core::motor`.
//!
//! ## DRV8837 Truth Table
//!
//! | IN1 | IN2 | Motor State                                |
...
// Use core types via re-export from parent module
use super::{Motor, MotorError, PwmPin};
