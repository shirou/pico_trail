//! Mission Management
//!
//! Storage and management of mission waypoints for autonomous navigation.
//!
//! # Mission Storage
//!
//! - Fixed-size waypoint array (max 50 waypoints)
//! - In-memory storage (no persistence in Phase 5)
//! - Supports upload/download via MAVLink
//!
//! # Waypoint Format
//!
...
//! # Thread Safety
//!
//! Mission storage is designed to be accessed from multiple tasks:
//! - Mission handler (upload/download)
//! - Navigation task (waypoint following)
