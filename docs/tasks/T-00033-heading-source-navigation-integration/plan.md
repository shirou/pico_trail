...
- [ ] Confirm ADR-00033-heading-source-integration is the governing design
...
- Documentation:
  - `docs/adr/ADR-00033-heading-source-integration.md` – Design specification
  - `docs/analysis/AN-00037-ahrs-navigation-control-integration.md` – Context and analysis
...
- [x] ADR-00033 referenced and followed
