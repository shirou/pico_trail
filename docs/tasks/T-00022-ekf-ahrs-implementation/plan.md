...
- Assumptions: IMU driver (T-00023) provides calibrated data at 400Hz
- Constraints: no_std, no heap, Embassy async, RP2040 no FPU

## ADR & Legacy Alignment

- [ ] Confirm ADR-00025-ekf-ahrs-implementation is referenced and followed
- [ ] Note: ADR-00001 (AHRS algorithm selection) is superseded by ADR-00025
- [ ] Mark T-00005 (DCM implementation) as superseded but keep code for reference
...
- Dependencies:
  ...
  - T-00023: IMU driver with `ImuSensor` trait
- Source Code to Modify:
...
- [ ] ADR-00025 referenced and followed
