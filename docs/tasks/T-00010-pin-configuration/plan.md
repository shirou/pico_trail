# T-00010 Pin Configuration Management
...
- [ ] Confirm ADR-00016-pin-configuration-management is referenced above
...
- Documentation:
  - `docs/adr/ADR-00016-pin-configuration-management.md` – Architecture decision and format specification
  - `docs/requirements/FR-00065-pin-configuration-management.md` – Functional requirements
...
- [x] ~~Do we need examples of parameter overrides in documentation?~~ → **DECIDED**: Examples added to FR-00065 and hwdef specification
