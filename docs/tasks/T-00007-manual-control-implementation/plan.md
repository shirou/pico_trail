...
- [ ] RC input to actuator response latency < 100ms (NFR-00010)
- [ ] 100% of actuator commands enforce armed state check (automated test required)
- [ ] Actuators neutral within 20ms of disarm event (NFR-00009)
- [ ] Vehicle layer memory usage < 5 KB RAM (NFR-00011)
...
- [x] Confirm the latest ADRs are referenced:
  - [ADR-00013-control-mode-architecture](../../adr/ADR-00013-control-mode-architecture.md) - Trait-based mode framework
  - [ADR-00010-actuator-abstraction-rover](../../adr/ADR-00010-actuator-abstraction-rover.md) - Actuator interface
  - [ADR-00011-rc-input-processing](../../adr/ADR-00011-rc-input-processing.md) - RC_CHANNELS handling
...
- Documentation:
  - `docs/adr/ADR-00011-rc-input-processing.md` – RC input design
  - `docs/adr/ADR-00010-actuator-abstraction-rover.md` – Actuator design
  - `docs/requirements/FR-00014-rc-channels-processing.md` – RC requirements
  - `docs/requirements/FR-00012-actuator-abstraction.md` – Actuator requirements
...
- Documentation:
  - `docs/adr/ADR-00013-control-mode-architecture.md` – Mode framework design
  - `docs/requirements/FR-00061-control-mode-framework.md` – Framework requirements
- Source Code to Modify:
...
- Documentation:
  - `docs/requirements/FR-00013-manual-mode.md` – Manual mode requirements
- Source Code to Modify:
