...
- [x] Confirm [ADR-w8d02-arming-system-architecture](../../adr/ADR-w8d02-arming-system-architecture.md) governs this work - Design follows trait-based architecture from ADR
...
- [x] **Integrate with SystemState**
  ...
  - [x] Implement `SystemState::arm_forced()` to bypass pre-arm checks (FR-exazo)
