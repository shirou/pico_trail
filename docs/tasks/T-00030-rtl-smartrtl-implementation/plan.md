# T-00030 RTL and SmartRTL Mode | Implementation Plan
...
- [ ] Confirm ADR-00031-rtl-smartrtl-architecture governs this work
- [ ] Confirm ADR-00013-control-mode-architecture for Mode trait compliance
...
- Documentation:
  - `docs/adr/ADR-00031-rtl-smartrtl-architecture.md` – Architecture reference
