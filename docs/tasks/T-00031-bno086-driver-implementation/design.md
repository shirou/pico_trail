# T-00031 BNO086 Driver Implementation - Design
...
- Parent Task:
  - [T-00031-bno086-driver-implementation](./README.md)
- Associated Plan:
  - [T-00031-bno086-driver-implementation-plan](./plan.md)
- Related Analysis:
...
- Related ADRs:
  - ADR-00026: I2C driver architecture (general reference)
