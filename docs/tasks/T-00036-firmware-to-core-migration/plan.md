# T-00036 Firmware-to-Core Migration Plan
...
- Assumptions: Core crate already has the module structure from T-00035
- Constraints: Zero `cfg` in core, `no_std` only, firmware build must not break

## ADR & Legacy Alignment

- [x] T-00035 workspace separation is complete (all 8 phases done)
