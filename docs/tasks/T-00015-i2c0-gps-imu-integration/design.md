# T-00015 I2C0 Multi-Sensor Bus Integration Design
...
- Associated Plan Document:
  - [T-00015-i2c0-gps-imu-integration-plan](./plan.md)
...
- Context: pico_trail autopilot requires GPS position data for waypoint navigation (FR-00004) but faces GPIO pin constraints (only GPIO 0, 1, 17, 22 available after motor control and WiFi allocations)
...
- Related ADRs: ADR-00019-i2c0-gps-imu-integration (I2C0 bus selected for pin efficiency)
...
1. **UART GPS + Expand GPIO Pins (Rejected)**
   ...
   - Decision Rationale: User explicitly stated pin constraint; ADR-00019 selected I2C0 for pin efficiency
