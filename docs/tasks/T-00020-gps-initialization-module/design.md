# T-00020 GPS Initialization Module | Design
...
- Associated Plan Document:
  - [T-00020-gps-initialization-module-plan](plan.md)
...
- Related ADRs: [ADR-00024-gps-initialization-module-structure](../../adr/ADR-00024-gps-initialization-module-structure.md)
...
- Standalone functions with feature flags chosen per ADR-00024 for simplicity and zero-cost abstraction
