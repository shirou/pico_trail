# T-00035 Workspace Separation Plan
...
- [ ] Note: Existing `src/core/traits/` already has partial trait abstraction (T-00025)
...
- Documentation:
  - `docs/analysis/AN-00039-crate-workspace-separation.md`
