# T-00019 Unified Waypoint Navigation Plan
...
- [ ] Confirm ADR-00023-unified-waypoint-navigation is referenced
...
- Documentation:
  - `docs/adr/ADR-00023-unified-waypoint-navigation.md` – Architecture decision
  - `docs/tasks/T-00019-unified-waypoint-navigation/design.md` – Design specification
