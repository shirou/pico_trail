...
- [ ] Confirm the latest ADRs are referenced:
  - [ADR-00007-transport-abstraction](../../adr/ADR-00007-transport-abstraction.md) - Trait-based abstraction
  - [ADR-00008-udp-primary-transport](../../adr/ADR-00008-udp-primary-transport.md) - UDP port 14550
  - [ADR-00009-wifi-config-strategy](../../adr/ADR-00009-wifi-config-strategy.md) - Compile-time config
...
- Documentation:
  - `docs/adr/ADR-00007-transport-abstraction.md` – Trait design and rationale
  - `docs/analysis/AN-00006-mavlink-network-transport.md` – ArduPilot pattern analysis
...
- Documentation:
  - `docs/adr/ADR-00009-wifi-config-strategy.md` – WiFi configuration approach
  - `docs/adr/ADR-00008-udp-primary-transport.md` – UDP transport design
