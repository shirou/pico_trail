# T-00038 Fix Guided Mode Heading Oscillation Design
...
This design addresses the rover spinning in circles during Guided mode navigation. The root causes are identified in AN-00044: P-only steering, hard heading source switching, and throttle independent of heading error. The fix applies three complementary mitigations to break the oscillation loop.
