...
- Current behavior: DCM algorithm implemented (T-49k7n) but superseded by EKF per ADR-ymkzt
...
- Related ADRs: [ADR-ymkzt-ekf-ahrs-implementation](../../adr/ADR-ymkzt-ekf-ahrs-implementation.md)
...
- Deprecation: ADR-6twis (AHRS algorithm selection) superseded
