...
- Assumptions:
  ...
  - Pin configuration available via BoardPinConfig (T-po5ns completed)
- Constraints:
...
- [x] Confirm ADR-4hx3d-motor-driver-abstraction is referenced above
- [ ] No legacy motor control system exists (new feature)
- [ ] Integration with differential drive kinematics (T-l7czt) will be in control modes
...
- Documentation:
  - `docs/adr/ADR-4hx3d-motor-driver-abstraction.md` – Architecture decision
  - `docs/requirements/FR-higbc-hbridge-motor-control.md` – Functional requirements
