...
- [ ] Confirm ADR-00026-mpu9250-i2c-driver-architecture is referenced and followed
- [ ] Mark T-00009-bmi088-imu-driver-implementation as superseded/deprecated
...
- [x] **Embassy task**
  ...
  - [x] Pass data to callback (placeholder for T-00022 EKF)
