...
- [ ] Confirm ADR-00030-vehicle-type-separation is followed (rover feature gate)
- [ ] Confirm ADR-00013-control-mode-architecture is followed (Mode trait)
...
- Documentation:
  - `docs/requirements/FR-00115-loiter-type-parameter.md` – Parameter requirements
...
- [x] ADRs referenced and followed (ADR-00030, ADR-00013)
- [x] No `unsafe` code
