# T-00029 Rover Loiter Mode Design
...
This design document specifies the implementation of Loiter mode for ground rovers. Loiter mode enables position holding at a fixed GPS point, supporting two behavioral types: Type 0 (simple stop) and Type 1 (active position correction). The implementation follows the Mode trait pattern from ADR-00013 and the vehicle type separation from ADR-00030.
...
- Related ADRs:
  - [ADR-00013-control-mode-architecture](../../adr/ADR-00013-control-mode-architecture.md) - Mode trait pattern
  - [ADR-00030-vehicle-type-separation](../../adr/ADR-00030-vehicle-type-separation.md) - Rover/Boat separation
...
- Total update should complete within 1ms (NFR-00081)
...
1. **Unified Rover/Boat Loiter**
   ...
   - Decision: Rejected per ADR-00030
