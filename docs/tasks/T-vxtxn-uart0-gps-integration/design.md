# T-vxtxn UART0 GPS Integration Design
...
- **Context**: NEO-M8N GPS module required for waypoint navigation (FR-333ym). Hardware verification revealed GPS uses UART interface, not I2C/DDC as initially assumed.
- **Current behavior**:
...
- **Related ADRs**:
  - ADR-8tp69: UART1 allocation to GPS (supersedes ADR-00mjv I2C0 multi-sensor bus)
...
- Mark I2C GPS requirement (FR-qfwhl) as "Superseded"
- Mark I2C GPS ADR (ADR-00mjv) as "Superseded"
- Mark I2C GPS task (T-meox8) as "Superseded"
...
- Mark superseded documents (FR-qfwhl, ADR-00mjv, T-meox8) with "Superseded" status and links to new docs
