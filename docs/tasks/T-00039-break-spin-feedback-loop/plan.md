...
Implement four mitigations to break the spin-in-place positive feedback loop discovered during field testing after T-00038: enable slew rate limiting, cap spin-in-place steering, add heading EMA filter, and use gyroscope yaw rate for D-term.
...
- [x] Confirm ADR-00033-heading-source-integration is referenced
...
- Documentation:
  - `docs/analysis/AN-00023-position-target-navigation.md` -- Root Causes 6, 7, 8
