# T-eiuvv STATUSTEXT Notification System
...
- Related ADRs: [ADR-jxvhf-global-statusnotifier](../../adr/ADR-jxvhf-global-statusnotifier.md)
...
3. **Dynamic Vec** (instead of heapless::Deque)
   ...
   - Rejected: Violates no_std and NFR-ssp9q requirements
...
- See [ADR-jxvhf-global-statusnotifier](../../adr/ADR-jxvhf-global-statusnotifier.md) for full rationale
