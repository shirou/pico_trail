# T-mrt6j Multi-Destination Log Storage and Routing
...
- Associated Plan Document:
  - [T-mrt6j-log-storage-routing-plan](plan.md)
...
- Related Analysis: [AN-nzsiz-logging-storage-and-routing](../../analysis/AN-nzsiz-logging-storage-and-routing.md)
...
- Responsibilities:
  - Bridge logs to StatusNotifier from T-eiuvv
