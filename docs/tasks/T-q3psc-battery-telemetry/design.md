...
- Associated Plan Document:
  - [T-q3psc-battery-telemetry-plan](./plan.md)
...
- [ ] ADC read completes within 2ms worst-case (NFR-r1h41)
...
- Related ADRs: [ADR-97ebh-battery-telemetry-architecture](../../adr/ADR-97ebh-battery-telemetry-architecture.md)
...
- **Update Rate**: 10 Hz battery state update (100ms period, 2ms budget per NFR-r1h41)
...
- Verify <2ms worst-case per NFR-r1h41
