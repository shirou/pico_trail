...
- ✅ ADC read completes within 2ms worst-case (NFR-00060) - 5-sample averaging \~10μs
...
- Follows ADR-00017: Full BATTERY_STATUS implementation selected for ArduPilot compatibility
