...
- Associated Design Document:
  - [T-00013-battery-telemetry-design](./design.md)
...
- [x] ADC read completes within 2ms worst-case (NFR-00060)
...
- Documentation:
  - `/docs/adr/ADR-00017-battery-telemetry-architecture.md` – Architecture decisions
  - `/docs/tasks/T-00013-battery-telemetry/design.md` – Detailed design
...
- [ ] ADR-00017 Implementation Notes verified complete
