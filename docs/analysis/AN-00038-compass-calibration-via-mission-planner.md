# AN-00038 Compass Calibration via Mission Planner
...
- Related Requirements:
  ...
  - [FR-00102-large-vehicle-magcal](../requirements/FR-00102-large-vehicle-magcal.md) (Phase 2: WMM-based)
- Related ADRs:
...
- [x] **[FR-00127](../requirements/FR-00127-compass-calibration-capability.md)**: System shall advertise MAV_PROTOCOL_CAPABILITY_COMPASS_CALIBRATION
...
- [x] **[FR-00128](../requirements/FR-00128-fixed-mag-cal-yaw-handler.md)**: System shall handle MAV_CMD_FIXED_MAG_CAL_YAW command
...
- [x] **[FR-00129](../requirements/FR-00129-magcal-gps-validation.md)**: System shall reject calibration when GPS fix is unavailable
...
- [x] **[NFR-00087](../requirements/NFR-00087-magcal-response-time.md)**: Calibration response shall complete within 1 second
...
2. [x] Create task: [T-00034-compass-calibration](../tasks/T-00034-compass-calibration/README.md)
