# AN-00037 AHRS-Navigation-Control Integration for Autonomous Navigation
...
- Related Analyses:
  ...
  - [AN-00028-bno086-imu-integration](AN-00028-bno086-imu-integration.md)
  - [AN-00027-mpu9250-imu-and-ekf-integration](AN-00027-mpu9250-imu-and-ekf-integration.md)
...
- Related Tasks:
  - [T-00032-ahrs-abstraction-layer](../tasks/T-00032-ahrs-abstraction-layer/README.md) (Complete)
  - [T-00018-navigation-controller](../tasks/T-00018-navigation-controller/README.md) (Complete)
  - [T-00031-bno086-driver-implementation](../tasks/T-00031-bno086-driver-implementation/README.md) (Complete)
  - [T-00033-heading-source-navigation-integration](../tasks/T-00033-heading-source-navigation-integration/README.md)

## Executive Summary

This analysis examines the integration between the AHRS (Attitude and Heading Reference System) subsystem and the Navigation/Control subsystems to enable autonomous navigation in Auto and Guided modes. With the BNO086 IMU driver (T-00031) and AHRS abstraction layer (T-00032) now complete, the next step is to connect AHRS heading output to the navigation controller and implement the autonomous control modes.
...
- [ ] **FR-DRAFT-3**: Guided mode shall navigate to position targets from SET_POSITION_TARGET_GLOBAL_INT
  ...
  - Note: Covered by FR-00083, needs implementation task
...
- [ ] **FR-DRAFT-4**: Auto mode shall execute uploaded waypoint missions sequentially
  ...
  - Note: Covered by FR-00082, needs implementation task
...
- ADR for Guided/Auto mode architecture (may extend ADR-00013)
...
- [ ] Is BNO086 yaw in NED frame (0° = North)? → Method: Verify in T-00032 implementation or test on hardware
...
- **Multi-sensor fusion (Kalman Filter)**: Defer to SoftwareAhrs/EKF implementation (T-00022)
...
- [ADR-00032 AHRS Abstraction Architecture](../adr/ADR-00032-ahrs-abstraction-architecture.md)
- [T-00032 AHRS Abstraction Layer Plan](../tasks/T-00032-ahrs-abstraction-layer/plan.md)
