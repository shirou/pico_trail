# AN-00005 IMU Sensor Selection for AHRS

## Metadata

- Type: Analysis
- Status: Deprecated
  <!-- Deprecated: Replaced by AN-00027-mpu9250-imu-and-ekf-integration. Decision changed from BMI088 to MPU-9250. -->
...
- [x] **FR-EXISTING**: Compatible with NFR-00002 (400Hz sampling)
  - Rationale: Already defined in requirements
  - Acceptance Criteria: Listed in NFR-00002
...
- **Sensor fusion alternatives**: AHRS DCM algorithm already chosen (ADR-00001)
