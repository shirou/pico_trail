# AN-5aniu Mode Entry Validation for Safe Mode Transitions
...
- Related Requirements:
  - [FR-a9rc3-mode-entry-sensor-validation](../requirements/FR-a9rc3-mode-entry-sensor-validation.md)
  - [FR-ap18p-ekf-health-validation](../requirements/FR-ap18p-ekf-health-validation.md)
  - [FR-bemq9-validation-failure-reporting](../requirements/FR-bemq9-validation-failure-reporting.md)
  ...
  - [FR-upqdp-disarmed-validation-exception](../requirements/FR-upqdp-disarmed-validation-exception.md)
  - [NFR-52km9-validation-error-message-usability](../requirements/NFR-52km9-validation-error-message-usability.md)
  - [NFR-p44ci-fallback-mode-reliability](../requirements/NFR-p44ci-fallback-mode-reliability.md)
  - [NFR-s4n00-validation-timing-performance](../requirements/NFR-s4n00-validation-timing-performance.md)
  - [NFR-sx06h-validation-memory-overhead](../requirements/NFR-sx06h-validation-memory-overhead.md)
  - [NFR-zxxit-validation-attempt-logging](../requirements/NFR-zxxit-validation-attempt-logging.md)
...
- Integrate with monitoring system (AN-dgpck) for sensor health
...
**Integration with Monitoring System** (AN-dgpck):
...
- [ ] **FR-DRAFT-5**: The system shall automatically select fallback mode when sensor requirements lost → Will become FR-<id>
  ...
  - Acceptance Criteria:
    - Monitor sensor health during flight (via AN-dgpck monitoring)
...
- **Monitoring integration**: Must work with health monitoring system (AN-dgpck)
...
- **EKF health checking**: Phase 1 stub returns true, Phase 2 integrate AHRS (FR-eyuh8)
