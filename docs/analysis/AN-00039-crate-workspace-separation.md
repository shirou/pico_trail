# AN-00039 Crate Workspace Separation for CFG Elimination
...
Previous analysis (AN-00029) identified \~150 feature gates and proposed conservative cleanup. This analysis explores the more aggressive workspace split approach, which offers cleaner architectural boundaries at the cost of significant refactoring effort. The key insight is applying "inversion of control" - async and logging are firmware concerns, not core concerns.
...
- [AN-00029-feature-gate-reduction](../analysis/AN-00029-feature-gate-reduction.md) - Previous feature gate analysis
