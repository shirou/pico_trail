...
- Related Analyses:
  - [AN-m4doh-boat-loiter-mode](AN-m4doh-boat-loiter-mode.md) (Boat Loiter Mode)
...
- [x] **FR-aw3h3-rover-loiter-mode**: System shall implement Loiter mode for position holding
  - See: [FR-aw3h3-rover-loiter-mode](../requirements/FR-aw3h3-rover-loiter-mode.md)

- [x] **FR-tzlof-loiter-point-calculation**: System shall calculate loiter point on mode entry
  - See: [FR-tzlof-loiter-point-calculation](../requirements/FR-tzlof-loiter-point-calculation.md)

- [x] **FR-30t03-loiter-type-parameter**: System shall support LOIT_TYPE parameter
  - See: [FR-30t03-loiter-type-parameter](../requirements/FR-30t03-loiter-type-parameter.md)

- [x] **FR-w0spp-position-drift-detection**: System shall detect position drift from loiter point
  - See: [FR-w0spp-position-drift-detection](../requirements/FR-w0spp-position-drift-detection.md)

- [x] **FR-9s9th-position-correction-navigation**: System shall navigate back to loiter point when drift exceeds threshold (Type 1)
  - See: [FR-9s9th-position-correction-navigation](../requirements/FR-9s9th-position-correction-navigation.md)

### Non-Functional Requirements

- [x] **NFR-biag9-loiter-drift-detection-performance**: Loiter mode drift detection shall complete within 1ms per update
  - See: [NFR-biag9-loiter-drift-detection-performance](../requirements/NFR-biag9-loiter-drift-detection-performance.md)

- [x] **NFR-32ade-position-hold-accuracy**: Position hold accuracy shall be within LOIT_RADIUS + GPS accuracy
  - See: [NFR-32ade-position-hold-accuracy](../requirements/NFR-32ade-position-hold-accuracy.md)
...
1. [x] Create ADR: Vehicle Type Separation architecture (affects all modes)
   - Created: [ADR-8icsq-vehicle-type-separation](../adr/ADR-8icsq-vehicle-type-separation.md)
2. [x] Create formal requirements: FR-aw3h3-rover-loiter-mode and related
   - Created: 5 FRs and 2 NFRs (see Links section)
3. [ ] Verify navigation controller readiness for Type 1
4. [x] Create task: T-n24yy-rover-loiter-mode-implementation
   - Created: [T-n24yy-rover-loiter-mode](../tasks/T-n24yy-rover-loiter-mode/README.md)
