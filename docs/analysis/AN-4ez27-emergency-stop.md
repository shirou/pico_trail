# AN-4ez27 Emergency Stop Mechanism for Safe Vehicle Shutdown
...
- Related Requirements:
  - [FR-cxts2-controlled-emergency-stop](../requirements/FR-cxts2-controlled-emergency-stop.md)
  - [FR-eeit0-stop-tier-system](../requirements/FR-eeit0-stop-tier-system.md)
  - [FR-g7uyd-emergency-stop-recovery](../requirements/FR-g7uyd-emergency-stop-recovery.md)
  - [FR-mg2bv-failsafe-integration](../requirements/FR-mg2bv-failsafe-integration.md)
  - [FR-p3lx0-emergency-stop-triggers](../requirements/FR-p3lx0-emergency-stop-triggers.md)
  - [FR-vt1vs-stop-state-tracking](../requirements/FR-vt1vs-stop-state-tracking.md)
  - [NFR-72q6d-emergency-stop-ram-overhead](../requirements/NFR-72q6d-emergency-stop-ram-overhead.md)
  - [NFR-ce6a6-emergency-stop-initiation-latency](../requirements/NFR-ce6a6-emergency-stop-initiation-latency.md)
  - [NFR-nuo5r-emergency-stop-event-logging](../requirements/NFR-nuo5r-emergency-stop-event-logging.md)
  - [NFR-s7fsz-controlled-stop-completion-time](../requirements/NFR-s7fsz-controlled-stop-completion-time.md)
  - [NFR-xzfww-no-rollover-loss-of-control](../requirements/NFR-xzfww-no-rollover-loss-of-control.md)
...
- **No failsafe integration**: Failsafe system (AN-kajh6) has no controlled stop option
...
- **Failsafe integration**: Emergency stop must work with failsafe system (AN-kajh6)
