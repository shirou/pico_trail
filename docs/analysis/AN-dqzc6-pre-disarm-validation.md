# AN-dqzc6 Pre-Disarm Validation for Safe Shutdown Conditions
...
- Related Analyses:
  - [AN-081u0-post-disarm-cleanup](AN-081u0-post-disarm-cleanup.md)
...
- Related Requirements:
  - [FR-ejx8b-disarm-validation-feedback](../requirements/FR-ejx8b-disarm-validation-feedback.md)
  - [FR-jmtr1-disarm-throttle-validation](../requirements/FR-jmtr1-disarm-throttle-validation.md)
  ...
  - [FR-waw1p-disarm-method-validation](../requirements/FR-waw1p-disarm-method-validation.md)
  - [NFR-eq7h1-pre-disarm-performance](../requirements/NFR-eq7h1-pre-disarm-performance.md)
...
- Integrate with post-disarm cleanup (AN-081u0)
...
impl SystemState {
    ...
    pub fn disarm(&mut self, method: DisarmMethod, forced: bool)
        ...
        // Execute post-disarm cleanup (AN-081u0)
