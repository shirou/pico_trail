# AN-00007 Manual Control Implementation for Rover via Mission Planner
...
- Related Requirements:
  - [FR-00047-mode-execution-framework](../requirements/FR-00047-mode-execution-framework.md)
  - [FR-00012-actuator-abstraction](../requirements/FR-00012-actuator-abstraction.md)
  - [FR-00043-manual-mode-implementation](../requirements/FR-00043-manual-mode-implementation.md)
  ...
  - [NFR-00012-actuator-failsafe-neutral](../requirements/NFR-00012-actuator-failsafe-neutral.md)
  - [NFR-00058-vehicle-layer-memory-overhead](../requirements/NFR-00058-vehicle-layer-memory-overhead.md)
- Related ADRs:
...
- Manual mode is fundamental safety feature (FR-00062 requirement)
...
- **Mode update rate**: 50 Hz (control loop frequency, per NFR-00001)
...
- [ ] **FR-DRAFT-2**: The system shall implement Manual mode with direct RC-to-actuator pass-through → Will become FR-<id>
  - Rationale: Core requirement from FR-00062, foundation for all vehicle control
  - Acceptance Criteria:
...
- **Real-time requirements**: 50 Hz control loop (per NFR-00001)
...
- [ ] Do we need RC failsafe action (Hold mode vs neutral outputs)? → Method: Follow FR-00003 failsafe requirements, default to Hold mode
