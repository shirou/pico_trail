# AN-00026 Logging Storage and Routing | Multi-destination Log System
...
- Related Requirements:
  ...
  - [FR-00095-log-retrieval-api](../requirements/FR-00095-log-retrieval-api.md)
  - [NFR-00072-log-push-performance](../requirements/NFR-00072-log-push-performance.md)
- Related ADRs: None
- Related Tasks:
...
| MAVLink Output    | None                         | STATUSTEXT for WARNING and above   | Need integration with AN-00020 |
...
The existing STATUSTEXT notification system (AN-00020) provides:
...
- [ ] **FR-DRAFT-2**: System shall route WARNING and above to MAVLink STATUSTEXT
  ...
  - Acceptance Criteria:
    ...
    - Integration with StatusNotifier from AN-00020
...
4. **MAVLink Integration:**
   - Depends on STATUSTEXT notification system (AN-00020)
...
- Router dispatches to configured sinks:
  ...
  - `StatusTextSink` - bridge to STATUSTEXT (via AN-00020)
...
| Dependency on AN-00020 STATUSTEXT       | Low         | Medium | Design interface first, implement independently |
...
3. **Integrate with AN-00020**: Ensure STATUSTEXT can receive logs from router
...
3. [ ] Wait for AN-00020 completion: STATUSTEXT implementation provides foundation
...
- Project code:
  ...
  - AN-00020-statustext-notifications - STATUSTEXT analysis
