# AN-00022 GPS Position Telemetry and Autonomous Navigation Foundation
...
- FR-00004 specifies GPS waypoint navigation with S-curve path planning
...
2. **Autonomous Navigation Foundation:**
   ...
   - Foundation for Auto mode implementation (FR-00004)
...
N/A - This is a continuation of GPS integration driven by existing requirements (FR-00004).
...
- [ ] **FR-DRAFT-3**: GPS position shall be accessible to navigation subsystem
  - Rationale: Waypoint navigation (FR-00004) requires GPS position input
  - Acceptance Criteria:
...
- [ ] What is the minimum GPS update rate needed for waypoint navigation?
  - Next step: Review FR-00004 acceptance criteria for position update requirements
