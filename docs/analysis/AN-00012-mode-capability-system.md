# AN-00012 Mode Capability Declaration System for Safe Mode-Specific Requirements
...
- Related Requirements:
  - [FR-00044-mode-capability-declaration](../requirements/FR-00044-mode-capability-declaration.md)
  - [FR-00058-validation-capability-enforcement](../requirements/FR-00058-validation-capability-enforcement.md)
  ...
  - [FR-00035-failsafe-capability-based-selection](../requirements/FR-00035-failsafe-capability-based-selection.md)
  - [NFR-00018-capability-query-zero-allocation](../requirements/NFR-00018-capability-query-zero-allocation.md)
  - [NFR-00016-capability-declaration-self-documenting](../requirements/NFR-00016-capability-declaration-self-documenting.md)
  - [NFR-00019-capability-system-extensibility](../requirements/NFR-00019-capability-system-extensibility.md)
  - [NFR-00017-capability-query-performance](../requirements/NFR-00017-capability-query-performance.md)
  - [NFR-00020-capability-system-memory-overhead](../requirements/NFR-00020-capability-system-memory-overhead.md)
...
- Integrate capabilities into mode validation (AN-00013)
- Integrate capabilities into pre-arm checks (AN-00008)
...
**Integration with Mode Validation** (AN-00013):
...
**Integration with Pre-Arm Checks** (AN-00008):
...
- **Existing architecture**: Must integrate with mode validation (AN-00013), pre-arm (AN-00008), lifecycle (AN-00014)
...
4. **Integrate with validation**: Use capabilities in mode entry validation (AN-00013)
5. **Integrate with pre-arm**: Use capabilities in arming checks (AN-00008)
