# AN-64ofl Firmware-to-Core Platform-Independent Code Migration
...
- Related Analyses:
  - [AN-q7k2m-crate-workspace-separation](AN-q7k2m-crate-workspace-separation.md)
  - [AN-kir7h-platform-abstraction](AN-kir7h-platform-abstraction.md)
  - [AN-li4m8-feature-gate-reduction](AN-li4m8-feature-gate-reduction.md)
...
This analysis investigates platform-independent code currently residing in `crates/firmware` that should be migrated to `crates/core`. Following the workspace separation established by AN-q7k2m, `crates/core` is designed to hold pure `no_std` business logic with zero `cfg` directives, while `crates/firmware` contains Embassy/RP2350-specific code.
...
The workspace split (AN-q7k2m) established two crates:
...
4. **Zero cfg in Core**: Per NFR-3y83q, core must maintain zero `#[cfg(...)]` directives
...
- [AN-q7k2m-crate-workspace-separation](AN-q7k2m-crate-workspace-separation.md) - Original workspace split analysis
- [AN-kir7h-platform-abstraction](AN-kir7h-platform-abstraction.md) - Platform abstraction strategy
- [FR-5f7tx-core-crate-nostd-purity](../requirements/FR-5f7tx-core-crate-nostd-purity.md) - Core crate purity requirement
- [NFR-3y83q-zero-cfg-core-crate](../requirements/NFR-3y83q-zero-cfg-core-crate.md) - Zero cfg directive requirement
