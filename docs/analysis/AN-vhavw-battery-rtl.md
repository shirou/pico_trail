# AN-vhavw Battery RTL | Automatic Return on Low Battery
...
- Related Analyses:
  ...
  - [AN-n8yb7-battery-telemetry](AN-n8yb7-battery-telemetry.md)
  - [AN-75408-rtl-mode](AN-75408-rtl-mode.md) (prerequisite)
...
- **Failsafe Framework Analysis**: [AN-kajh6-failsafe-system](AN-kajh6-failsafe-system.md) provides comprehensive failsafe architecture
...
- Integrate battery checker with FailsafeExecutor from AN-kajh6
...
- **Failsafe framework**: Must integrate with existing failsafe system from AN-kajh6
...
5. **Integrate with FailsafeExecutor** from AN-kajh6 failsafe framework
...
- Project failsafe analysis: [AN-kajh6-failsafe-system](AN-kajh6-failsafe-system.md)
- Project battery telemetry: [AN-n8yb7-battery-telemetry](AN-n8yb7-battery-telemetry.md)
