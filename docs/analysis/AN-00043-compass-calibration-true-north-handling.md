# AN-00043 Compass Calibration True North Handling
...
3. **Consider WMM integration** (Phase 2 from AN-00038) if operating in areas with significant declination variation
