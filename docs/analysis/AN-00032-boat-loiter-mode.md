...
- Related Analyses:
  - [AN-00034-loiter-mode](AN-00034-loiter-mode.md) (Rover Loiter Mode)
...
**Scope:** This analysis covers **Boat implementation only**. Rover Loiter mode is covered separately in [AN-00034-loiter-mode](AN-00034-loiter-mode.md).
...
- `src/rover/mode/loiter.rs`: Rover Loiter mode (per AN-00034)
...
1. [ ] Create ADR: Vehicle Type Separation architecture (shared with Rover AN-00034)
...
- **Rover Loiter mode**: Covered in AN-00034-loiter-mode
...
- [AN-00034-loiter-mode](AN-00034-loiter-mode.md): Rover Loiter Mode (companion analysis)
