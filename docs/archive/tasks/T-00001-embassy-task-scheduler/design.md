...
- Associated Plan Document:
  - [T-00001-embassy-task-scheduler-plan](plan.md)
- Related ADRs:
...
- [ ] Control loop latency ≤ 20ms (meets NFR-00001)
- [ ] IMU sampling rate = 400Hz ± 5% (meets NFR-00002)
...
- Related ADRs: ADR-00005 selected Embassy over RTIC and custom scheduler
...
- **Decision Rationale**: Embassy chosen for development velocity and async I/O (see ADR-00005)
