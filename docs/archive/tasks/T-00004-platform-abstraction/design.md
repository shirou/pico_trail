...
- Associated Plan Document:
  - [T-00004-platform-abstraction-plan](plan.md)
- Related ADRs:
...
- Related ADRs: [ADR-00003-platform-abstraction](../../../adr/ADR-00003-platform-abstraction.md) - Selected three-tier design over two-tier embedded-hal approach
...
- No `unsafe` code outside `src/platform/` per NFR-00004
...
2. **Direct HAL Usage (No Abstraction)**
   ...
   - Cons: Platform-specific code scattered everywhere, difficult to port, violates NFR-00005
...
- Mock implementations enable hardware-free testing per NFR-00005
