# FR-5zqns NAV DO Command Separation
...
- Dependent Requirements:
  - [FR-0q1tf-do-change-speed](FR-0q1tf-do-change-speed.md)
  - [NFR-8oq1h-mission-command-execution-overhead](NFR-8oq1h-mission-command-execution-overhead.md)
- Related Tasks:
