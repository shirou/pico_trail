# FR-00070 ArduPilot STATUSTEXT Conventions
...
| Long prefix + message exceeds 50 chars too often           | Low    | Medium     | Use concise prefixes, rely on chunking (FR-00071)   | Analyze typical message lengths       |
