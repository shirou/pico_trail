# FR-00044 Mode Capability Declaration System
...
- Related Analysis: [AN-00008-pre-arm-checks](../analysis/AN-00008-pre-arm-checks.md)
...
- Dependent Requirements:
  ...
  - [FR-00058-validation-capability-enforcement](FR-00058-validation-capability-enforcement.md)
  - [FR-00051-prearm-capability-enforcement](FR-00051-prearm-capability-enforcement.md)
  - [FR-00035-failsafe-capability-based-selection](FR-00035-failsafe-capability-based-selection.md)
  - [NFR-00016-capability-declaration-self-documenting](NFR-00016-capability-declaration-self-documenting.md)
  - [NFR-00018-capability-query-zero-allocation](NFR-00018-capability-query-zero-allocation.md)
  - [NFR-00017-capability-query-performance](NFR-00017-capability-query-performance.md)
...
- Analysis: [AN-00012-mode-capability-system](../analysis/AN-00012-mode-capability-system.md)
