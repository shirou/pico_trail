# FR-hibx1 SmartRTL to Direct RTL Fallback
...
- [ ] Direct RTL mode activated with same entry validation (FR-bwqq7)
...
| Direct RTL fails too           | High   | Very Low   | Separate validation (FR-bwqq7) | Test both modes         |
