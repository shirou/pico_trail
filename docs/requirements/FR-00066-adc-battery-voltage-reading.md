# FR-00066 | ADC Battery Voltage Reading
...
- [ ] Reading completes within allocated time budget (see NFR-00060)
...
- Raw ADC value feeds into voltage conversion (FR-00069)
...
This requirement applies only to embedded targets (pico2_w feature). Host tests shall use mock ADC values (see NFR-00062).
