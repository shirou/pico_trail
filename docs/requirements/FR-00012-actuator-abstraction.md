# FR-00012 Actuator Abstraction for Rover
...
- Dependent Requirements:
  ...
  - [NFR-00012-actuator-failsafe-neutral](NFR-00012-actuator-failsafe-neutral.md)
...
Actuator calibration stored as parameters (see FR-00006):
...
- **Calibration via parameters**: Use parameter system (FR-00006) for servo calibration
