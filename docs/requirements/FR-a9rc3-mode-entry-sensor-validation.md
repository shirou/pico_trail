# FR-a9rc3 Mode Entry Sensor Requirement Validation When Armed
...
- Dependent Requirements:
  - [FR-9qug9-...](FR-9qug9-validation-capability-enforcement.md)
  - [FR-ap18p-...](FR-ap18p-ekf-health-validation.md)
  - [FR-bemq9-...](FR-bemq9-validation-failure-reporting.md)
  - [FR-dch39-...](FR-dch39-fallback-mode-selection.md)
  - [FR-7e0cr-mode-lifecycle-management](FR-7e0cr-mode-lifecycle-management.md)
  - [FR-upqdp-...](FR-upqdp-disarmed-validation-exception.md)
  - [NFR-s4n00-...](NFR-s4n00-validation-timing-performance.md)
  - [NFR-sx06h-...](NFR-sx06h-validation-memory-overhead.md)
  - [NFR-zxxit-...](NFR-zxxit-validation-attempt-logging.md)
...
- Sensor health monitoring system (AN-dgpck)
...
- Sensor health checks should query monitoring system (AN-dgpck)
