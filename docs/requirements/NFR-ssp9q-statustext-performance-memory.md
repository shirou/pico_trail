# NFR-ssp9q STATUSTEXT Performance and Memory Constraints
...
- Compatible with `no_std` environments (see NFR-e82vp)
...
- Defer chunking to dequeue phase (see FR-7qki7)
...
| Message truncation due to 200-char limit                      | Low    | Medium     | Enforce limit at API level, chunk long messages       | See NFR-1wo70 for length limits               |
