# FR-lia7r Direct RTL Navigate to Home Position
...
- Dependent Requirements:
  ...
  - [FR-crqdd-rtl-gps-loss-handling](FR-crqdd-rtl-gps-loss-handling.md)
  - [FR-hibx1-smartrtl-rtl-fallback](FR-hibx1-smartrtl-rtl-fallback.md)
  - [NFR-u885h-rtl-update-rate](NFR-u885h-rtl-update-rate.md)
  - [NFR-dwe8t-rtl-memory-overhead](NFR-dwe8t-rtl-memory-overhead.md)
- Related Analyses:
...
**Note:** Direct RTL is the fallback mode. SmartRTL (FR-8dug4) is the default RTL behavior that retraces the recorded path.
