# FR-cxts2 Controlled Emergency Stop with Gradual Deceleration
...
- Dependent Requirements:
  - [FR-eeit0-stop-tier-system](FR-eeit0-stop-tier-system.md)
  ...
  - [NFR-72q6d-emergency-stop-ram-overhead](NFR-72q6d-emergency-stop-ram-overhead.md)
  - [NFR-ce6a6-emergency-stop-initiation-latency](NFR-ce6a6-emergency-stop-initiation-latency.md)
  - [NFR-nuo5r-emergency-stop-event-logging](NFR-nuo5r-emergency-stop-event-logging.md)
  - [NFR-s7fsz-controlled-stop-completion-time](NFR-s7fsz-controlled-stop-completion-time.md)
  - [NFR-xzfww-no-rollover-loss-of-control](NFR-xzfww-no-rollover-loss-of-control.md)
