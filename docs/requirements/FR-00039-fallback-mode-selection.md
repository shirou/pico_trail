# FR-00039 Automatic Fallback Mode Selection When Sensor Requirements Lost
...
- Related Analysis: [AN-00009-armed-state-monitoring](../analysis/AN-00009-armed-state-monitoring.md)
...
- Dependent Requirements:
  - [FR-00035-...](FR-00035-failsafe-capability-based-selection.md)
  - [NFR-00032-...](NFR-00032-fallback-mode-reliability.md)

## Requirement Statement

The system shall automatically select fallback mode when sensor requirements lost by monitoring sensor health during flight (via AN-00009 monitoring), detecting when current mode requirements no longer met, selecting fallback mode hierarchy (Stabilize → Manual), and logging fallback mode transition with reason.
...
- Armed state monitoring system (AN-00009)
