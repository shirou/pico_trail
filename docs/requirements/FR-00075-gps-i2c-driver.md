# FR-00075 GPS I2C/DDC Driver Implementation for NEO-M8N
...
**This requirement has been superseded by [FR-00077-gps-uart-driver](FR-00077-gps-uart-driver.md) due to hardware verification that the GPS module uses UART interface, not I2C.**
...
- Prerequisite Requirements:
  - [FR-00078-i2c0-multi-sensor-bus](FR-00078-i2c0-multi-sensor-bus.md)
