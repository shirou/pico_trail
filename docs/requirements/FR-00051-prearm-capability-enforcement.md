# FR-00051 Pre-Arm Checks Enforce Arming Permissions Using Capability Queries
...
- Dependent Requirements:
  - [FR-00060-force-arm-override](FR-00060-force-arm-override.md)
...
4. Integration with pre-arm checks:
   ...
   - See AN-00008 for full pre-arm check system
...
- Pre-arm checks system (AN-00008)
