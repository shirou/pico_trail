# FR-00030 Disarmed Mode Change Validation Exception for Pre-Flight Configuration
...
- Related Requirements: [FR-00046-mode-entry-sensor-validation](FR-00046-mode-entry-sensor-validation.md)
- Related ADRs: TBD
- Related Tasks: TBD
...
1. Mode change function checks armed state before validation:
   ...
   - If `is_armed() == true`, perform full validation (FR-00046)
...
- Mode validation function (FR-00046)
- Pre-arm checks (AN-00008) verify mode compatibility
