# NFR-pvpky Capability Query Execution Under 1 Microsecond Per Query
...
- Related Requirements: [NFR-cy29p-capability-query-zero-allocation](NFR-cy29p-capability-query-zero-allocation.md)
- Related ADRs: TBD
- Related Tasks: TBD
