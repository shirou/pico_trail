# FR-xex86 Failsafe System Uses Capability Queries for Fallback Mode Selection
...
- Related Analysis: [AN-kajh6-failsafe-system](../analysis/AN-kajh6-failsafe-system.md)
...
4. Integration with failsafe system:
   ...
   - See FR-dch39 for fallback selection details
   - See AN-kajh6 for full failsafe system
...
- Failsafe system (AN-kajh6)
- Sensor health monitoring
- Fallback mode selection (FR-dch39)
