# FR-e9yu9 Async STATUSTEXT Message Queue
...
- [ ] Heapless queue with 16-message capacity (see NFR-ssp9q)
...
struct QueuedMessage {
    ...
    text: heapless::String<200>,  // Max 200 chars per NFR-1wo70
}
```
...
- Must use heapless::Deque (no heap allocation, see NFR-ssp9q)
