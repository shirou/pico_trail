# NFR-8oq1h Mission Command Execution Overhead
...
- Timing budget violation (per NFR-iuk5h 50Hz navigation rate)
...
- Compatibility: Must not violate NFR-iuk5h (50Hz navigation update rate)
