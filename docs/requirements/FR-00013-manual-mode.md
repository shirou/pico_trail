# FR-00013 Manual Mode Implementation
...
- Dependent Requirements:
  ...
  - [NFR-00009-actuator-failsafe](NFR-00009-actuator-failsafe.md)
  - [NFR-00010-manual-control-latency](NFR-00010-manual-control-latency.md)
...
Manual mode is required by FR-00062 (Vehicle Operational Modes) and is the simplest mode, making it the ideal starting point for vehicle control implementation.
...
- [ ] Mode update rate: 50 Hz minimum (per NFR-00001)
...
2. **Actuator Layer**: Enforces armed check, ignores commands when disarmed (see FR-00012)
...
- `src/vehicle/actuators.rs` - Actuator interface (see FR-00012)
