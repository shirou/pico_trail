# NFR-p8ylh Circle Path Calculation Performance
...
The 1ms budget is half of the navigation controller's 2ms budget (NFR-wtdig), ensuring Circle mode overhead is minimal.
