# FR-exazo Force Arm Emergency Override
...
- Analysis: [AN-r2fps-pre-arm-checks](../analysis/AN-r2fps-pre-arm-checks.md) - Force-arm mechanism
- ADR: [ADR-w8d02-arming-system-architecture](../adr/ADR-w8d02-arming-system-architecture.md) - Force-arm integration
