# NFR-p44ci Fallback Mode Selection Guaranteed Success for Vehicle Safety
...
- Related Requirements: [FR-dch39-fallback-mode-selection](FR-dch39-fallback-mode-selection.md)
- Related ADRs: TBD
- Related Tasks: TBD
