# FR-00061 Control Mode Execution Framework
...
- Dependent Requirements:
  - [FR-00083-guided-mode-navigation](FR-00083-guided-mode-navigation.md)
...
The framework is the foundation for all autonomous and manual control modes required by FR-00062.
...
- [ ] Support at least 5 modes: Manual, Hold, Auto, RTL, Guided (per FR-00062)
...
Mode transitions follow rules defined in FR-00062:
...
| ------------------------------------------------ | ------ | ---------- | ------------------------------------------------------------ | --------------------------------------------- |
| Mode transition during critical maneuver         | High   | Low        | Defer transition until safe (see FR-00062)                   | Test: mode change during high-speed turn      |
