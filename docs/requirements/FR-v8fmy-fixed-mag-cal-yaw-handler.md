# FR-v8fmy Fixed Mag Cal Yaw Command Handler
...
- Dependent Requirements:
  - [FR-t3gpv-magcal-gps-validation](FR-t3gpv-magcal-gps-validation.md)
  - [NFR-q7kcr-magcal-response-time](NFR-q7kcr-magcal-response-time.md)
- Related ADRs:
...
Future Phase 2 (FR-e2urj) may implement full WMM-based calibration if field testing shows BNO086 internal calibration is insufficient.
...
| ------------------------------------- | ------ | ---------- | --------------------------------- | --------------------------------- |
| BNO086 calibration insufficient       | Medium | Low        | Phase 2: implement WMM (FR-e2urj) | Field testing with compass errors |
...
**Difference from FR-e2urj:**

| Aspect          | This FR (Phase 1)         | FR-e2urj (Phase 2)           |
| --------------- | ------------------------- | ---------------------------- |
