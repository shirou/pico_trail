# ADR-00026 9-Axis IMU I2C Driver Architecture
...
- Supersedes ADRs:
  - [ADR-00006-imu-driver-architecture](../adr/ADR-00006-imu-driver-architecture.md) (Deprecated - BMI088/SPI)
- Related Analyses:
...
- Related Tasks:
  ...
  - ~~[T-00024-icm20948-driver-implementation](../tasks/T-00024-icm20948-driver-implementation/README.md)~~ (Cancelled)
  - ~~[T-00023-mpu9250-driver-implementation](../tasks/T-00023-mpu9250-driver-implementation/README.md)~~ (Cancelled)

## Context

The pico_trail autopilot requires IMU sensor data for attitude estimation via EKF. The previous ADR (ADR-00006) specified BMI088 with SPI interface, but project constraints now favor 9-axis IMUs (ICM-20948 or MPU-9250) with I2C.
