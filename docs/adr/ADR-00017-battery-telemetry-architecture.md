# ADR-00017 Battery Telemetry Architecture
...
- Metric 2: ADC read completes within 2ms worst-case (meets NFR-00060)
...
- Low overhead (2ms ADC read budget per NFR-00060)
