# ADR-00010 Actuator Abstraction: Normalized Commands with PWM Conversion
...
- **Abstraction Overhead**: \~400 bytes RAM (acceptable within NFR-00011 budget)
...
- **Calibration via Parameters**: Uses parameter system (FR-00006)
...
```rust
// Load calibration from parameter system (FR-00006)
