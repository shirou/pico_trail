# ADR-00009 WiFi Configuration via Compile-Time Constants
...
- [ ] Do we need WiFi connection retry logic? → Next step: Yes, implement exponential backoff (covered in FR-00011)
