# ADR-00013 Control Mode Architecture: Trait-Based Polymorphism with Mode Manager
...
The autopilot must support multiple control modes (Manual, Hold, Auto, RTL, Guided) as defined in FR-00062. Each mode has distinct behavior:
...
- **Memory Budget**: Vehicle layer < 5 KB RAM (NFR-00011)
...
- **Memory**: \~2 KB for framework (within NFR-00011 5 KB budget)
