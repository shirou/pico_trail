# ADR-cg5iz RTL and SmartRTL Mode Architecture
...
- **Memory Budget**: SmartRTL path storage ≤ 10 KB RAM (NFR-leuwp)
- **Direct RTL overhead**: ≤ 100 bytes RAM (NFR-dwe8t)
- **Real-time**: Navigation update at 50 Hz (NFR-u885h)
- **Entry validation**: ≤ 1ms (NFR-nm9hf)
