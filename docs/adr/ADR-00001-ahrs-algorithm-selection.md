# ADR-00001 AHRS Algorithm Selection: DCM with Optional EKF Upgrade

## Metadata

- Type: ADR
- Status: Superseded
  <!-- Superseded by ADR-00025-ekf-ahrs-implementation. Decision changed from DCM to EKF as primary AHRS algorithm. -->
