# ADR-00006 IMU Driver Architecture

## Metadata

- Type: ADR
- Status: Deprecated
  <!-- Deprecated: Replaced by new ADR for MPU-9250. Decision changed from BMI088/SPI to MPU-9250/I2C. See AN-00027-mpu9250-imu-and-ekf-integration for rationale. -->
...
- Related Tasks:
  ...
  - [T-00009-bmi088-imu-driver-implementation](../tasks/T-00009-bmi088-imu-driver-implementation/README.md)
...
- AHRS DCM algorithm is implemented and ready (ADR-00001)
- Platform abstraction layer provides SPI/I2C/GPIO traits (ADR-00003)
...
1. **400Hz Sampling Requirement**: NFR-00002 mandates 400Hz with <1ms jitter
...
- **Option C** — Cheapest, simplest | Jitter concerns, may not meet NFR-00002
...
- **MPU6050**: I2C jitter measured at 0.5-2ms on RP2040, fails NFR-00002
