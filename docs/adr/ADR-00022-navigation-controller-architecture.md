# ADR-00022 Navigation Controller Architecture: Bearing-Based Path Following
...
- Related ADRs:
  ...
  - [ADR-00021-gps-state-management](ADR-00021-gps-state-management.md)
  - [ADR-00014-differential-drive-kinematics](ADR-00014-differential-drive-kinematics.md)
- Related Tasks:
...
- Works within the Mode trait architecture (ADR-00013)
- Extensible for future L1 controller upgrade

### Constraints

- **Compute Budget**: Must complete navigation calculation within 2ms (NFR-00069)
