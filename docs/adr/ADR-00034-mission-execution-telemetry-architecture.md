# ADR-00034 Mission Execution Telemetry Architecture
...
The initial unified waypoint navigation (ADR-00023) established MissionStorage as the single source of truth and implemented basic Auto mode navigation through NAV_WAYPOINT items. Three categories of gaps remain between the current implementation and a fully functional mission system:
